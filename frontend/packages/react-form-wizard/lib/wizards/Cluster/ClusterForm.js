...
import { WizKeyValue, WizMultiSelect, Section, WizSelect, Step, WizTextDetail, Tile, WizTiles, WizardPage, WizArrayInput, WizCheckbox, WizTextInput, } from '../../src';
export function ClusterForm() {
    const history = useHistory();
    return (_jsxs(WizardPage, { title: "Create cluster", breadcrumb: [{ label: 'Managed clusters', to: '.' }], onSubmit: () => Promise.resolve(undefined), onCancel: () => history.push('./?route=wizards'), children: [_jsxs(Step, { label: "Infrastructure provider", id: "infrastructure-provider", children: [_jsxs(Section, { label: "Infrastructure provider", prompt: "Select the infrastructure for the cluster", children: [_jsxs(WizTiles, { path: "provider", label: "Cloud infrastructure providers", children: [_jsx(Tile, { id: "aws", value: "aws", label: "Amazon Web Services" }), _jsx(Tile, { id: "azr", value: "azr", label: "Microsoft Azure" }), _jsx(Tile, { id: "gcp", value: "gcp", label: "Google Cloud Platform" }), _jsx(Tile, { id: "ost", value: "ost", label: "Red Hat OpenStack Platform" }), _jsx(Tile, { id: "vsp", value: "vsp", label: "VMWare vSphere" }), _jsx(Tile, { id: "bare", value: "bare", label: "Bare metal" })] }), _jsx(WizTiles, { id: "centrallyManagedCredentials", path: "provider", label: "Centrally managed", children: _jsx(Tile, { id: "onp", value: "onp", label: "On premise" }) })] }), _jsx(Section, { label: "Credentials", prompt: "Select the infrastructure for the cluster", hidden: (item) => !item.provider, children: _jsx(WizSelect, { path: "credential", label: "Infrastructure credentials", placeholder: "Select the credentials for the infrastructure", options: ['default'], required: true }) })] }), _jsx(Step, { label: "Cluster details", id: "cluster-details", children: _jsxs(Section, { label: "Cluster details", prompt: "Enter the cluster details", children: [_jsx(WizTextInput, { path: "name", label: "Cluster name", placeholder: "Enter the cluster name", required: true }), _jsx(WizSelect, { path: "region", label: "Region", options: Object.keys(awsRegions) }), _jsx(WizSelect, { path: "clusterSet", label: "Cluster set", placeholder: "Select a cluster set", helperText: "A cluster sets is a group of clusters that can be targeted as a group.", options: ['default'], required: true }), _jsx(WizTextInput, { path: "baseDnsDomain", label: "Base DNS domain", placeholder: "Enter the Base DNS domain" }), _jsx(WizSelect, { path: "releaseImage", label: "Release image", placeholder: "Select a release image", options: ['default'], required: true }), _jsx(WizKeyValue, { path: "labels", label: "Additional labels" })] }) }), _jsx(Step, { label: "Control plane", id: "control-plane", children: _jsx(ControlPlaneStep, {}) }), _jsx(Step, { label: "Worker pools", id: "worker-pools", children: _jsx(WorkerPoolsStep, {}) }), _jsx(Step, { label: "Networking", id: "networking", children: _jsxs(Section, { label: "Networking", prompt: "Enter networking options", description: "Configure network access for your cluster. One network is created by default.", children: [_jsx(WizSelect, { path: "networkType", label: "Network type", options: ['default'], required: true }), _jsxs(WizArrayInput, { path: "networks", label: "Networks", placeholder: "Add network", collapsedContent: _jsx(WizTextDetail, { path: "clusterCidr", placeholder: "Expand to edit the network" }), children: [_jsx(WizTextInput, { path: "clusterCidr", label: "Cluster network CIDR" }), _jsx(WizTextInput, { path: "hostPrefix", label: "Network host prefix" }), _jsx(WizTextInput, { path: "serviceCidr", label: "Service network Cidr" }), _jsx(WizTextInput, { path: "machienCidr", label: "Machine CIDR" })] })] }) }), _jsx(Step, { label: "Proxy", id: "proxy", children: _jsxs(Section, { label: "Proxy", prompt: "Configure a proxy", description: "Production environments can deny direct access to the Internet and instead have an HTTP or HTTPS proxy available. You can configure a new OpenShift Container Platform cluster to use a proxy by configuring the proxy settings.", children: [_jsx(WizCheckbox, { path: "useProxy", label: "Use proxy" }), _jsx(WizTextInput, { path: "httpProxy", label: "Http Proxy ", helperText: "Requires this format: http://<username>:<pswd>@<ip>:<port>", required: true, hidden: (item) => !item.useProxy }), _jsx(WizTextInput, { path: "httpsProxy", label: "Https Proxy", helperText: "Requires this format: https://<username>:<pswd>@<ip>:<port>", required: true, hidden: (item) => !item.useProxy }), _jsx(WizTextInput, { path: "noProxy", label: "No Proxy", helperText: "By default, all cluster egress traffic is proxied, including calls to hosting cloud provider APIs. Add sites to No Proxy to bypass the proxy if necessary.", hidden: (item) => !item.useProxy }), _jsx(WizTextInput, { path: "additionalTrustBundle", label: "Additional Trust Bundle", hidden: (item) => !item.useProxy })] }) }), _jsx(Step, { label: "Automation", id: "automation", children: _jsx(Section, { label: "Automation", prompt: "Configure a Ansible automation", description: "Choose an automation job template to automatically run Ansible jobs at different stages of a cluster's life cycle. To use this feature, the Ansible Automation Platform Resource Operator must be installed.", children: _jsx(WizSelect, { path: "ansibleTemplate", label: "Ansible Automation Template", options: ['default'] }) }) })] }));
}
...
export function WorkerPoolsStep() {
    return (_jsx(Section, { label: "Worker pools", prompt: "Enter the worker pools", description: "One or more worker nodes will be created to run the container workloads in this cluster.", children: _jsxs(WizArrayInput, { path: "workerPools", label: "Worker pools", placeholder: "Add worker pool", collapsedContent: _jsx(WizTextDetail, { path: "name", placeholder: "Expand to edit the worker pool details" }), children: [_jsx(WizTextInput, { path: "name", label: "Pool name" }), _jsx(WizSelect, { path: "zones", label: "Zones", options: ['default'] }), _jsx(WizSelect, { path: "instanceType", label: "Instance type", options: ['default'] }), _jsx(WizSelect, { path: "rootStorage", label: "Root storage (GiB)", options: ['default'] })] }) }));
}
