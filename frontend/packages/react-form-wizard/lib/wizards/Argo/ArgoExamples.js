...
function onCancel(history) {
    history.push(`./${RouteE.ArgoCD}`);
}
export function ApplicationSetExamples() {
    const history = useHistory();
    return (_jsx(Catalog, { title: "Application Set Wizard Examples", breadcrumbs: [{ label: 'Example Wizards', to: RouteE.Wizards }, { label: 'Application Set Wizard Examples' }], cards: [
            {
                icon: _jsx(ArgoIcon, {}),
...
export function CreateApplicationSet() {
    ...
    return (_jsx(ArgoWizard, { breadcrumb: [
        ...
        ], createClusterSetCallback: () => null, ansibleCredentials: ansibleCredentials, argoServers: servers, namespaces: namespaces, onSubmit: onSubmit, onCancel: () => onCancel(history), placements: placements, channels: channels, timeZones: timeZones, getGitRevisions: async () => {
            await new Promise((resolve) => setTimeout(resolve, 1000));
            return Promise.resolve(['branch-1', 'branch-2']);
        }, getGitPaths: async () => {
            await new Promise((resolve) => setTimeout(resolve, 1000));
            return Promise.resolve(['path-1', 'path-2']);
        }, clusters: clusters, clusterSets: clusterSets, clusterSetBindings: clusterSetBindings }));
}
export function EditApplicationSet() {
    ...
    return (_jsx(ArgoWizard, { breadcrumb: [
            ...
            await new Promise((resolve) => setTimeout(resolve, 1000));
            return Promise.resolve(['path-1', 'path-2']);
        }, clusters: clusters, clusterSets: clusterSets, clusterSetBindings: clusterSetBindings, resources: [
            {
...
//# sourceMappingURL=ArgoExamples.js.map