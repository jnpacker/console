...
export function CreatePolicy() {
    const history = useHistory();
    return (_jsx(PolicyWizard, { title: "Create policy", namespaces: namespaces, policies: policies, placements: placements, placementRules: placementRules, clusters: clusters, clusterSets: clusterSets, clusterSetBindings: clusterSetBindings, onSubmit: onSubmit, onCancel: () => onCancel(history) }));
}
export function EditPolicy(props) {
    const history = useHistory();
    return (_jsx(PolicyWizard, { namespaces: namespaces, policies: policies, clusterSets: clusterSets, clusterSetBindings: clusterSetBindings, placements: placements, placementRules: placementRules, title: "Edit policy", onSubmit: onSubmit, onCancel: () => onCancel(history), editMode: EditMode.Edit, resources: YamlToObject(props.yaml, true), gitSource: "http://example.com", clusters: clusters }));
}
export function EditPolicyLimitClusterAdmin() {
    return _jsx(EditPolicy, { yaml: editPolicyLimitClusterAdmin });
}
export function EditPolicyRole() {
    return _jsx(EditPolicy, { yaml: editPolicyRole });
}
export function EditPolicyRoleBinding() {
    return _jsx(EditPolicy, { yaml: editPolicyRoleBinding });
}
export function EditPolicyComplianceOperatorInstall() {
    return _jsx(EditPolicy, { yaml: editPolicyComplianceOperatorInstall });
}
export function EditPolicyComplianceOperatorCisScan() {
    return _jsx(EditPolicy, { yaml: editPolicyComplianceOperatorCisScan });
}
export function EditPolicyComplianceOperatorE8Scan() {
    return _jsx(EditPolicy, { yaml: editPolicyComplianceOperatorE8Scan });
}
export function EditPolicyGatekeeperOperatorDownstream() {
    return _jsx(EditPolicy, { yaml: editPolicyGatekeeperOperatorDownstream });
}
export function EditPolicyNamespace() {
    return _jsx(EditPolicy, { yaml: editPolicyNamespace });
}
export function EditPolicyPod() {
    return _jsx(EditPolicy, { yaml: editPolicyPod });
}
export function EditPolicyCertificate() {
    return _jsx(EditPolicy, { yaml: editPolicyCertificate });
}
export function EditPolicyEtcdEncryption() {
    return _jsx(EditPolicy, { yaml: editPolicyEtcdEncryption });
}
export function EditPolicyLimitMemory() {
    return _jsx(EditPolicy, { yaml: editPolicyLimitMemory });
}
export function EditPolicyImageManifestVuln() {
    return _jsx(EditPolicy, { yaml: editPolicyImageManifestVuln });
}
export function EditPolicyPsp() {
    return _jsx(EditPolicy, { yaml: editPolicyPsp });
}
export function EditPolicyScc() {
    return _jsx(EditPolicy, { yaml: editPolicyScc });
}
