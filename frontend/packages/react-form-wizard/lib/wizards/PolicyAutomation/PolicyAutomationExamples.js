...
export function PolicyAutomationExamples() {
    ...
    return (_jsx(Catalog, { title: "Policy Automation Examples", breadcrumbs: [{ label: 'Example Wizards', to: RouteE.Wizards }, { label: 'Policy Automation Examples' }], cards: [
            {
...
export function CreatePolicyAutomation() {
    const history = useHistory();
    return (_jsx(PolicyAutomationWizard, { breadcrumb: [
        ...
        ], title: "Create policy automation", onSubmit: onSubmit, onCancel: () => onCancel(history), policy: {
        ...
        ], createCredentialsCallback: () => window.open('http://google.com', '_blank'), resource: {
...
export function EditPolicyAutomation() {
    ...
    return (_jsx(PolicyAutomationWizard, { breadcrumb: [
        ...
        ], editMode: EditMode.Edit, title: "Edit policy automation", onSubmit: onSubmit, onCancel: () => onCancel(history), policy: {
            metadata: { name: 'my-policy', namespace: 'my-namespace' },
        }, credentials: [
            {
                metadata: {
...
//# sourceMappingURL=PolicyAutomationExamples.js.map