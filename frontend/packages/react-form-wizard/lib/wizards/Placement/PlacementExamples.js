...
export function CreatePlacement() {
    const history = useHistory();
    return (_jsx(PlacementWizard, { title: "Create placement", namespaces: namespaces, policies: policies, placements: placements, placementRules: placementRules, clusterSets: clusterSets, clusterSetBindings: clusterSetBindings, onSubmit: onSubmit, onCancel: () => onCancel(history), defaultPlacementType: PlacementKind, bindingSubjectKind: PolicySetKind, bindingSubjectApiGroup: PolicySetApiGroup, resources: [], clusters: clusters }));
}
export function CreatePlacementRule() {
    const history = useHistory();
    return (_jsx(PlacementWizard, { title: "Create placement rule", namespaces: namespaces, policies: policies, placements: placements, placementRules: placementRules, clusterSets: clusterSets, clusterSetBindings: clusterSetBindings, onSubmit: onSubmit, onCancel: () => onCancel(history), defaultPlacementType: PlacementRuleKind, bindingSubjectKind: PolicySetKind, bindingSubjectApiGroup: PolicySetApiGroup, resources: [{ ...PlacementRuleType, metadata: { name: '', namespace: '' } }], clusters: clusters }));
}
export function EditPlacement() {
    const history = useHistory();
    return (_jsx(PlacementWizard, { namespaces: namespaces, policies: policies, clusterSets: clusterSets, clusterSetBindings: clusterSetBindings, placements: placements, placementRules: placementRules, title: "Edit placement", onSubmit: onSubmit, onCancel: () => onCancel(history), editMode: EditMode.Edit, resources: [...placement1Resources], defaultPlacementType: PlacementKind, bindingSubjectKind: PolicySetKind, bindingSubjectApiGroup: PolicySetApiGroup, clusters: clusters }));
}
export function EditPlacementRule() {
    const history = useHistory();
    return (_jsx(PlacementWizard, { namespaces: namespaces, policies: policies, clusterSets: clusterSets, clusterSetBindings: clusterSetBindings, placements: placements, placementRules: placementRules, title: "Edit placement rule", onSubmit: onSubmit, onCancel: () => onCancel(history), editMode: EditMode.Edit, resources: [...placementRule1Resources], defaultPlacementType: PlacementRuleKind, bindingSubjectKind: PolicySetKind, bindingSubjectApiGroup: PolicySetApiGroup, clusters: clusters }));
}
export function EditPlacements() {
    const history = useHistory();
    return (_jsx(PlacementWizard, { namespaces: namespaces, policies: policies, clusterSets: clusterSets, clusterSetBindings: clusterSetBindings, placements: placements, placementRules: placementRules, title: "Edit placements", onSubmit: onSubmit, onCancel: () => onCancel(history), editMode: EditMode.Edit, resources: [
            ...placement1Resources,
            ...placement2Resources,
            ...placementRule1Resources,
            ...placementRule2Resources,
        ], defaultPlacementType: PlacementRuleKind, bindingSubjectKind: PolicySetKind, bindingSubjectApiGroup: PolicySetApiGroup, clusters: clusters }));
}
