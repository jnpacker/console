...
import { EditAgentModal } from '@openshift-assisted/ui-lib/cim';
import { useTranslation } from '../../../../../../../lib/acm-i18next';
import ScaleUpForm from './ScaleUpForm';

type ScaleUpFormValues = {
                ...
                <ModalBoxBody>
                  <Stack hasGutter>
                    ...
                    {error && (
                      <StackItem>
                        <Alert
                          title={t('Failed to add hosts to the cluster')}
